...
namespace LearnOpenTK
{
    ...
    public class Window : GameWindow
    {
        ...
        private ShadersPair shadersPair;
        ...
        protected override void OnLoad()
        {
            ...
            
            {
                ...
                var positionLocation = shadersPair.GetAttribLocation("aPos");
                GL.EnableVertexAttribArray(positionLocation);
                GL.VertexAttribPointer(positionLocation, 3, VertexAttribPointerType.Float, false, 6 * sizeof(float), 0);

                var normalLocation = shadersPair.GetAttribLocation("aNormal");
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            shadersPair.SetMatrix4("view", _camera.GetViewMatrix());
            shadersPair.SetMatrix4("projection", _camera.GetProjectionMatrix());

            shadersPair.SetVector3("viewPos", _camera.Position);

            shadersPair.SetInt("material.diffuse", 0);
            shadersPair.SetInt("material.specular", 1);
            ...
            shadersPair.SetFloat("light.linear", 0.09f);
            shadersPair.SetFloat("light.quadratic", 0.032f);
            shadersPair.SetVector3("light.ambient", new Vector3(0.2f));
            shadersPair.SetVector3("light.diffuse", new Vector3(0.5f));
            shadersPair.SetVector3("light.specular", new Vector3(1.0f));
            ...
            shadersPair.SetMatrix4("model", model);
